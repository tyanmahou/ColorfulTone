...
namespace ct
{
	...
	public:
		...
		static void Spacing(const s3d::Font& font, s3d::StringView text, const Vec2& topLeft, const Vec2& space, const s3d::Color& color = s3d::Palette::White);
		static void Spacing(const s3d::Font& font, s3d::StringView text, const Vec2& topLeft, const Vec2& space, const s3d::Color& color, const s3d::Color& shadeColor);
