...
void HomographyStyle::drawJudgeLine() const
{
...
void HomographyStyle::drawTapEffect(NoteType type, NoteType baseType)
{
...
void HomographyStyle::drawJudgeEffect(Score::Judge judge, NoteType type, s3d::int64 diff)
{
    m_effetcs[0].add<JudgeEffect>(judge, diff, Vec2{ GetX(type),400 });
}

void HomographyStyle::draw(const Bar& note, double count, double scrollRate) const
{
...
void HomographyStyle::draw(const Note& note, double count, double scrollRate) const
{
...
void HomographyStyle::draw(const LongNote& note, double count, double scrollRate) const
{
...
void HomographyStyle::draw(const RepeatNote& note, double count, double scrollRate) const
{
    if (note.isFirstTap())
        count = 0;
...
void HomographyStyle::draw(const RepeatEnd& note, double count, double scrollRate) const
{
    const auto parent = note.getParent();
