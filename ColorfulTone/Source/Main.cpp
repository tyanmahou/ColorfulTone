...
{
	Shader::Compile(L"Shaders/mainBG.hlsl", L"Shaders/mainBG2.ps", ShaderType::PS_4_0, 1);
	Shader::Compile(L"Shaders/ResultBG.hlsl", L"Shaders/ResultBG3.ps", ShaderType::PS_4_0, 1);
	Shader::Compile(L"Shaders/startTrans.hlsl", L"Shaders/startTrans3.ps", ShaderType::PS_4_0, 1);
}
